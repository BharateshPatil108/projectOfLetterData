...
public class ConstituencyWise_MLC_Category_Inner_Adapter extends RecyclerView.Adapter<ConstituencyWise_MLC_Category_Inner_Adapter.InnerViewHolder> {
    private final String[] mlc_category_outer_data;
    private final Context context;
    private final Map<String, Integer> mlc_category_innerDataList;

    public ConstituencyWise_MLC_Category_Inner_Adapter(String[] const_mlc_category_outerdata, Map<String, Integer> const_mlc_category_innerList, Context context) {
        this.mlc_category_outer_data = const_mlc_category_outerdata;
        this.mlc_category_innerDataList = const_mlc_category_innerList;
    ...
    public void onBindViewHolder(@NonNull InnerViewHolder holder, int position) {
        // holder.mlc_cat_detail_TextView.setText(mlc_category_innerDataList.get(position));

        String receivedValue = String.valueOf(mlc_category_innerDataList.get("Received"));
        String disposedValue = String.valueOf(mlc_category_innerDataList.get("Disposed"));
        String acceptedValue = String.valueOf(mlc_category_innerDataList.get("Accepted"));
        String rejectedValue = String.valueOf(mlc_category_innerDataList.get("Rejected"));
        String pendingValue = String.valueOf(mlc_category_innerDataList.get("Pending"));
